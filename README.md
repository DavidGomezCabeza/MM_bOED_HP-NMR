...
## Directories: ##
- ***BayesianInference***: Directory containing all the scripts used for the Bayesian inference of parameters for the simplistic models (with and without pyruvate transport term) and the Michaelis Menten model. 
...
## HELP ##
For any inquiry, please contact Dr. David Gomez-Cabeza at dgomez@ibecbarcelona.eu. 
